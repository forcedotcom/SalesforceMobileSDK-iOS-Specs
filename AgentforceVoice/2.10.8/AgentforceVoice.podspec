...
AgentforceVoice provides real-time voice interaction capabilities for the Agentforce Mobile SDK, enabling conversational AI experiences through speech in your iOS applications.
  ...
  s.source           = { :http => 'https://github.com/salesforce/AgentforceMobileSDK-iOS/releases/download/19.29.3/AgentforceMobileVoice-262-3.xcframework.zip' }
  ...
  s.dependency 'AgentforceService', '~> 6'
  s.dependency 'SalesforceNetwork'
  s.dependency 'SalesforceLogging'
  s.dependency 'Messaging-InApp-Core', '~> 1.12.0'
  s.dependency 'Messaging-Multimedia-Common', '~> 1.12.0'
  s.dependency 'Messaging-Multimedia-Core', '~> 1.12.0'
end
