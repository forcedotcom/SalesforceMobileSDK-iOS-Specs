Pod::Spec.new do |s|
  ...
  s.source           = { :http => 'https://github.com/salesforce/AgentforceMobileSDK-iOS/releases/download/18.33.14-rc1/AgentforceMobileCustomization-262-2-RC1.xcframework.zip' }
