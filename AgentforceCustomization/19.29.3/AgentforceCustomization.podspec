Pod::Spec.new do |s|
  ...
  # (like AgentforceVoice). https://github.com/salesforce/AgentforceMobileSDK-iOS/releases/download/19.29.3/AgentforceMobileCustomization-262-3.xcframework.zip is the dSYM-stripped xcframework zip.
  s.source           = { :http => 'https://github.com/salesforce/AgentforceMobileSDK-iOS/releases/download/19.29.3/AgentforceMobileCustomization-262-3.xcframework.zip' }
  ...
  s.dependency 'MobileCustomizationFramework', '~> 6.5'
  s.dependency 'MobileCustomizationHXL', '~> 6.5'
end
